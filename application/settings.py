...
MIDDLEWARE = [
    ...
    "src.utils.middleware.ApiLoggingMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": (
        ...
        "src.utils.filters.CustomDjangoFilterBackend",
        "rest_framework.filters.SearchFilter",
        "rest_framework.filters.OrderingFilter",
    ),
    "DEFAULT_PAGINATION_CLASS": "src.utils.pagination.CustomPagination",  # 自定义分页
...
AUTHENTICATION_BACKENDS = ["src.utils.backends.CustomBackend"]
# ================================================= #
# ****************** simplejwt配置 ***************** #
# ================================================= #
